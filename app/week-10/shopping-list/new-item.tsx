      ...
      <form onSubmit={handleSubmit}>
        <div className="flex items-stretch gap-0 rounded-xl overflow-hidden border-2 border-gray-300 shadow-sm bg-white focus-within:border-purple-400 transition-colors">
          ...
          <button
            ...
            className="px-5 font-semibold text-white bg-linear-to-br from-blue-600 to-lightblue-500 hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed text-sm"
          >
            Add
          </button>
        </div>
